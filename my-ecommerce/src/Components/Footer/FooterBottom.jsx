...
const FooterBottom = () => {
  ...
  const lougradouro =
    "Av: Juscelino Kubstchek de Oliveira, 2326, Cidade Jardim, Ubá-MG";
  ...
  return (
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-3  ">
            ...
            <ul className="payments__grid d-flex mt-3">
              <li className="payments__itens " title="Cartão Visa">
                <img
                  src={visacard}
                  alt="Siga-nos no Instagram"
                  width={widthRedesSocial}
              ...
              <li className="payments__itens" title="Cartão Mastercar">
                <img
                  src={mastercard}
                  alt="Siga-nos no Instagram"
                  width={widthRedesSocial}
              ...
              <li className="payments__itens" title="Transferência PIX">
                <img
                  src={pix}
                  alt="Siga-nos no Instagram"
                  width={widthRedesSocial}
              ...
              <li className="payments__itens" title="Dineiro">
                <img
                  src={money}
                  alt="Siga-nos no Instagram"
                  width={widthRedesSocial}
        ...
        <span class="whatsapp-footer">
          <a
            href="https://api.whatsapp.com/send?phone=5532988264239&text=Ol%C3%A1!%20Estou%20enteressado%20em%20saber%20mais%20dos%20seus%20produtos,%20estou%20vindo%20do%20site%20da%20empresa."
            target="_blank"
          >
